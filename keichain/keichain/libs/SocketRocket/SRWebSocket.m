...
- (void)closeWithCode:(NSInteger)code reason:(NSString *)reason;
{
    ...
    dispatch_async(_workQueue, ^{
        ...
        //modified by lili 增加readyState == SR_OPEN的判断 SR_CONNECTING状态不存在 先保留
...
- (void)send:(id)data;
{
    //modified by lili SR_CONNECTING -> SR_OPEN
...
- (void)main;
{
    @autoreleasepool {
        ...
        NSTimer *timer = [[NSTimer alloc] initWithFireDate:[NSDate distantFuture] interval:0.0 target:self selector:@selector(distantFire) userInfo:nil repeats:NO];
